...
<head>
    ...
    <title>Detail Konten - {{ $kolaborasi->judul }}</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>

<body class="bg-gray-100 p-6">
    <div class="max-w-3xl mx-auto bg-white p-6 rounded shadow">
        <h2 class="text-xl font-bold mb-4">Isi Detail Konten: {{ $kolaborasi->judul }}</h2>
        ...
        <form method="POST" action="{{ route('kolaborasi.detail.submit', $kolaborasi->id) }}"
            ...
            <div>
                <label class="block mb-1 font-medium">Topic (opsional)</label>
            ...
            <div>
                <label class="block mb-1 font-medium">Judul Description (opsional)</label>
            ...
            <div>
                ...
                <textarea name="target" rows="3" class="w-full border p-2 rounded" required>{{ old('target') }}</textarea>
            </div>

            <div>
                <label class="block mb-1 font-medium">Sasaran</label>
                <textarea name="sasaran" rows="3" class="w-full border p-2 rounded" required>{{ old('sasaran') }}</textarea>
            </div>
            {{-- 
            <div>
            ...
            <div class="flex gap-4">
                ...
                <a href="{{ route('kolaborasi.dynamic', $kolaborasi->create_view) }}"
