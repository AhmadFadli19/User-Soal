    ...
    <section class="bg-white rounded-lg shadow p-6 mb-10 mt-4">
      ...
      >
        <div class="flex flex-col lg:flex-row gap-6">
          <img
            src="{{ asset('storage/' . $BannerCard->image) }}"
            alt="banner"
        ...
        <div class="lg:w-3/4 space-y-10">
          ...
          <section>
            ...
            <p class="text-justify">
              {{ $BannerCardDetail->judul_description }}
            </p>
            <ul class="list-disc pl-5 mt-3 space-y-1">
              <li>
                {{ $BannerCardDetail->description_kelas }}
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p class="text-justify">
              {{ $BannerCardDetail->target }}
            </p>
            <ul class="list-disc pl-5 mt-3 space-y-1">
              <li>
                {{ $BannerCardDetail->sasaran }}
              </li>
            </ul>
          </section>
        </div>
